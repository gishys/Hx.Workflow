...
{
    public class ApplicationFormGroupRepository
        : EfCoreRepository<WkDbContext, ApplicationFormGroup, Guid>
        , IApplicationFormGroupRepository
    {
        public ApplicationFormGroupRepository(IDbContextProvider<WkDbContext> options)
            : base(options)
        { }
        /// <summary>
        /// 判断是否存在同一标题的组
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual async Task<ApplicationFormGroup?> GetByIdAsync(Guid id)
        {
