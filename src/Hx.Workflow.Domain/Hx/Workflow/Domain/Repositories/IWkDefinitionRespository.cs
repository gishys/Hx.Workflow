...
namespace Hx.Workflow.Domain.Repositories
{
    public interface IWkDefinitionRespository : IBasicRepository<WkDefinition>
    {
        ...
        Task<List<WkDefinition>> GetListForRegistrationAsync(CancellationToken cancellationToken = default);
        ...
        Task<List<WkNodeCandidate>> GetCandidatesAsync(Guid id, string stepName, int? version = null, CancellationToken cancellationToken = default);
